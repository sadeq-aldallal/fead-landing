        ...
        <div className="glass-card p-8">
          ...
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center space-x-4">
              <div className="w-16 h-16 bg-[var(--brand-green)]/20 rounded-full flex items-center justify-center">
                <User className="w-8 h-8 text-[var(--brand-green)]" />
              </div>
              <div>
            ...
            <div className="space-y-6">
              ...
              {!isChangingPassword ? (
                <div className="space-y-4">
                  ...
                  <div className="p-4 bg-white/5 rounded-lg">
                    <h3 className="text-white font-medium mb-2">Email Verification</h3>
                  ...
                  <form onSubmit={handlePasswordChange} className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 bg-white/5 border border-white/10 rounded-lg text-white placeholder-white/30 focus:outline-none focus:ring-2 focus:ring-[var(--brand-green)] focus:border-transparent"
