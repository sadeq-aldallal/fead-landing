...
export const AccountDeletionPolicy: React.FC = () => {
  return (
    <div className="min-h-screen dark-gradient-bg py-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="glass-card p-8">
          <h1 className="text-3xl font-bold text-white mb-8">Account Deletion Policy</h1>
          
          <div className="space-y-6 text-white/80">
            <section>
              <h2 className="text-xl font-semibold text-white mb-4">1. Account Deletion Request</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-xl font-semibold text-white mb-4">2. What Gets Deleted</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-white mb-4">3. Deletion Timeline</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-white mb-4">4. Instagram Data</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-white mb-4">5. Data We May Retain</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-xl font-semibold text-white mb-4">6. Before You Delete</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-white mb-4">7. Reactivation</h2>
              <p>
